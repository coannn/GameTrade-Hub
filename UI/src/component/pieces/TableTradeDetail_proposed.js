...
export default function TableProposedItem(props) {
  const [item, setItem] = useState([]);
  // fetch get to collect for get data
  const getItem = async () => {
    const response = await fetch("http://localhost:8000/TradePlaza/display_tradedetail/proposedItem/"+props.itemNumber);
